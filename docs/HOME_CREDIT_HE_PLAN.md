...
- CKKS is the governing scheme for Home Credit packed numeric sums, masked
  sums, means, rates, correlation support values, and scoring-style linear
  algebra.
- All active Home Credit EDA implementation and reporting must follow CKKS.
- Non-CKKS work is outside the active Home Credit EDA plan unless explicitly
  reopened.
